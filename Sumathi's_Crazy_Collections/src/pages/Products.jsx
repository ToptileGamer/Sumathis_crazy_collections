...
const bracelets = [
  ...
  { name: "Resize", img: resize, price: "₹299", description: "Adjustable bracelet design with unique flair." },
  { name: "Resized", img: resized, price: "₹299", description: "Same great style, now in a resized version." },
